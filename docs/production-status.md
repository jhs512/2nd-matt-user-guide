...
GitHub production 환경에 RAILWAY_TOKEN을 등록했습니다. CLI 세션으로 projectTokenCreate를 실행하면 Not Authorized였지만 Railway 브라우저 프로젝트 Settings → Tokens에서 production 전용 토큰을 생성할 수 있었습니다. 토큰 값은 문서에 기록하지 않습니다.
